    ...
    <nav>
        <ul>
            ...
            <li class="has-submenu">
                ...
                <ul class="submenu">
                    <li><a href="dashboard-user.php?page=tebar-bibit"><i class="fas fa-seedling"></i>Tebar Bibit</a></li>
                    <li><a href="dashboard-user.php?page=pemeliharaan-ikan"><i class="fas fa-hand-holding-water"></i>Pemeliharaan Ikan</a></li>
                    <li><a href="dashboard-user.php?page=biaya-pakan"><i class="fas fa-coins"></i>Biaya Pakan</a></li>
                    <li><a href="dashboard-user.php?page=biaya-pendukung"><i class="fas fa-file-invoice-dollar"></i> Biaya Pendukung</a></li>
                    <li><a href="dashboard-user.php?page=panen"><i class="fas fa-balance-scale"></i>Panen</a></li>
